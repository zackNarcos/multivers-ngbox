...
import { ComponentModel, DirectiveModel, PipeModel, ServiceModel } from "../models/models";

export const getElementFiles = (projectPath: string, type: 'component' | 'pipe' | 'service' | 'directive'): string[] => {
